...
const char COMMUNITY_FORUM_URL[] = "https://discord.gg/QG9aGwU";
const char REPORT_ISSUE_URL[] = "https://github.com/intucoin/INTUcoin/issues";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("IntuCoin %1").arg(Settings::instance().getVersion()));
