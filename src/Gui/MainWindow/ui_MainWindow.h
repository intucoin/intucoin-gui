...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/intucoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutIntuCoinAction = new QAction(MainWindow);
        m_aboutIntuCoinAction->setObjectName(QStringLiteral("m_aboutIntuCoinAction"));
        m_aboutIntuCoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutIntuCoinAction);
        ...
        QObject::connect(m_aboutIntuCoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutIntuCoinAction->setText(QApplication::translate("MainWindow", "About IntuCoin", Q_NULLPTR));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND INTU", Q_NULLPTR));
